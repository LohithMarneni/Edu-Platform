...
const { Assessment } = require('../student_dash_ba/project/backend/models/Assessment');
const { Course } = require('../student_dash_ba/project/backend/models/Course');
